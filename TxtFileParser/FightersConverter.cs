...
namespace TxtFileParser
{
    internal class FightersConverter
    {
        ...
        public bool Parse(string filePath, string outputFolder)
        {
            ...
            {
                Console.WriteLine($"Fighter conversion error: {ex.Message}");
                res = false;
            }
            return res;
        }
