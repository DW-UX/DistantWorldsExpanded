                ...
                if (design5 != null)
                {
                  ...
                  if (!design5.IsEquivalent(design1))
                  {
                    ...
                    if (flag3)
                    {
                      ...
                      {
                        design5.PictureRef = (int) ((byte) (ShipImageHelper.StandardShipImageStartIndex + empire.DesignPictureFamilyIndex * ShipImageHelper.ShipSetImageCount) + (Galaxy.ResolveLegacySubRole(design5.SubRole) - (byte) 1));
                      }
                      else
                      {
                        int num6 = -1;
                        ...
                        if (num6 >= 0)
                        {
                          design5.PictureRef = (int) ((byte) (ShipImageHelper.StandardShipImageStartIndex + num6 * ShipImageHelper.ShipSetImageCount) + (Galaxy.ResolveLegacySubRole(design5.SubRole) - (byte) 1));
                        }
                        else
                        {
...
label_77:
                          ...
                          if (source2.Count<Race>() > 0)
                          {
                            ...
                            design5.PictureRef = (int) ((byte) (ShipImageHelper.StandardShipImageStartIndex + num7 * ShipImageHelper.ShipSetImageCount) + (Galaxy.ResolveLegacySubRole(design5.SubRole) - (byte) 1));
                          }
                          else
