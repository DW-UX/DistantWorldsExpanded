...
namespace DistantWorlds.Types
{
    ...
    ISerializable
  {
    ...
    int IComparable<StellarObject>.CompareTo(StellarObject other) => this.SortTag.CompareTo(other.SortTag);

    int IComparable<Creature>.CompareTo(Creature other) => this.SortTag.CompareTo(other.SortTag);

    int IComparable<BuiltObject>.CompareTo(BuiltObject other) => this.SortTag.CompareTo(other.SortTag);
