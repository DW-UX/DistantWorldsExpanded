...
namespace DistantWorlds.Types
{
  public class RaceImageCache
  {
      ...
      Bitmap[] pirateImagesAlt)
    {
      ...
      {
        this._RaceImagesSmall[index] = GraphicsHelper.ScaleImage(raceImages[index], 24, 24, 1f);
        this._RaceImages30[index] = GraphicsHelper.ScaleImage(raceImages[index], 30, 30, 1f);
        this._RaceImages30Transparent[index] = GraphicsHelper.ScaleImage(raceImages[index], 30, 30, 0.67f);
      }
      ...
      {
        this._PirateImagesSmall[index] = GraphicsHelper.ScaleImage(pirateImages[index], 24, 24, 1f);
        this._PirateImages30[index] = GraphicsHelper.ScaleImage(pirateImages[index], 30, 30, 1f);
        this._PirateImages30Transparent[index] = GraphicsHelper.ScaleImage(pirateImages[index], 30, 30, 0.67f);
      }
    }
