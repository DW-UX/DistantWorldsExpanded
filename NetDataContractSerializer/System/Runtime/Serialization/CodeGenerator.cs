...
namespace System.Runtime.Serialization
{
    internal class CodeGenerator
    {
        ...
        internal void VerifyParameterCount(MethodInfo methodInfo, int expectedCount)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.ParameterCountMismatch, methodInfo.Name, methodInfo.GetParameters().Length, expectedCount)));
            }
        }
        ...
        internal Type LoadMember(MemberInfo memberInfo)
        {
            ...
            else if (memberInfo.MemberType == MemberTypes.Property)
            {
                ...
                if (property != null)
                {
                    ...
                    if (getMethod == null)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.NoGetMethodForProperty, property.DeclaringType, property)));
                    }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.CannotLoadMemberType, memberInfo.MemberType, memberInfo.DeclaringType, memberInfo.Name)));
            }
        ...
        internal void StoreMember(MemberInfo memberInfo)
        {
            ...
            else if (memberInfo.MemberType == MemberTypes.Property)
            {
                ...
                if (property != null)
                {
                    ...
                    if (setMethod == null)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.NoSetMethodForProperty, property.DeclaringType, property)));
                    }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.CannotLoadMemberType, memberInfo.MemberType)));
            }
        }
        ...
        internal void Store(object var)
        {
            ...
            else
            {
                ...
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.CanOnlyStoreIntoArgOrLocGot0, DataContract.GetClrTypeFullName(var.GetType()))));
            }
        }
        ...
        internal void Ldc(object o)
        {
            ...
            else
            {
                switch (Type.GetTypeCode(valueType))
                {
                    ...
                    default:
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.UnknownConstantType, DataContract.GetClrTypeFullName(valueType))));
                }
            }
        }
        ...
        internal void Ldelem(Type arrayElementType)
        {
            ...
            else
            {
                ...
                if (opCode.Equals(OpCodes.Nop))
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.ArrayTypeIsNotSupported, DataContract.GetClrTypeFullName(arrayElementType))));
                }
        ...
        private void InternalConvert(Type source, Type target, bool isAddress)
        {
            ...
            if (target.IsValueType)
            {
                if (source.IsValueType)
                {
                    ...
                    if (opCode.Equals(OpCodes.Nop))
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.NoConversionPossibleTo, DataContract.GetClrTypeFullName(target))));
                    }
                    else
                    {
                        if (codeGenTrace != CodeGenTrace.None)
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.IsNotAssignableFrom, DataContract.GetClrTypeFullName(target), DataContract.GetClrTypeFullName(source))));
                }
            }
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer2.CreateSerializationException(SR.Format(SR.ExpectingEnd, expected.ToString())));
        }
