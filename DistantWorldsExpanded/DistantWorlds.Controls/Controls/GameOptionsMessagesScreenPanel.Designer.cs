...
partial class GameOptionsMessagesScreenPanel {
  ...
  private void InitializeComponent() {
    ...
    this.chkOptionsScrollingMessageExploration = new();
    this.chkOptionsScrollingMessageIntelligenceMissions = new();
    this.chkOptionsScrollingMessageResearchBreakthrough = new();
    this.chkOptionsScrollingMessageEmpireMetDestroyed = new();
    this.chkOptionsScrollingMessageColonyGainLoss = new();
    this.chkOptionsScrollingMessageUnderAttackCivilianShips = new();
    this.chkOptionsScrollingMessageWarTradeSanctions = new();
    this.chkOptionsScrollingMessageDiplomacyTreaties = new();
    this.chkOptionsScrollingMessageRequestWarning = new();
    this.chkOptionsScrollingMessageNewShipBuilt = new();
    this.chkOptionsScrollingMessageConstructionResourceShortage = new();
    this.chkOptionsScrollingMessageUnderAttackCivilianBases = new();
    this.chkOptionsScrollingMessageUnderAttackMilitaryShips = new();
    this.chkOptionsScrollingMessageUnderAttackExplorationShips = new();
    this.chkOptionsScrollingMessageUnderAttackOtherStateBases = new();
    this.chkOptionsScrollingMessageUnderAttackColonyConstructionShips = new();
    this.chkOptionsScrollingMessageUnderAttackColoniesSpaceports = new();
    this.chkOptionsScrollingMessageShipNeedsRefuelling = new();
    this.chkOptionsScrollingMessageShipMissionComplete = new();
