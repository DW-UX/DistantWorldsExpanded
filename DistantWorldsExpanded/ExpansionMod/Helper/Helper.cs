...
namespace ExpansionMod
{
    internal static class Helper
    {
        ...
        {
            return Path.Combine(AppContext.BaseDirectory, _ModsRootFolder, _ExpansionModFolder, filePath);
        }
        public static string GetModConfigPath()
        {
            return Path.Combine(AppContext.BaseDirectory, _ModsRootFolder, _ModConfigFile);
        }
    }
}
